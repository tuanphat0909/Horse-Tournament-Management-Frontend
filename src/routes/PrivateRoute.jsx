...
export function PrivateRoute({ children, allowedRoles }) {
  ...
  if (!authReady) {
    return (
      <div style={{ backgroundColor: '#0b101e' }} className="min-h-screen flex items-center justify-center">
  ...
  if (statusLower !== 'active') {
    const forbiddenPaths = ['/spectator/tournaments', '/spectator/predictions', '/owner/horses', '/owner/tournaments', '/owner/registrations', '/owner/jockeys'];
