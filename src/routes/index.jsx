      ...
      <ConfirmProvider>
        ...
        <Routes>
          ...
          <Route
            ...
            element={
              <PrivateRoute allowedRoles={['Jockey']}>
                <JockeyDashboardPage />
              </PrivateRoute>
            }
          />
          ...
          />
          <Route
            path="/jockey/violations"
            element={
              <PrivateRoute allowedRoles={['Jockey']}>
                <JockeyViolationsPage />
              </PrivateRoute>
            }
          />
          <Route
          ...
          />
          <Route
            path="/referee/horse-check"
            element={
              <PrivateRoute allowedRoles={['Referee']}>
                <RefereeHorseCheckPage />
              </PrivateRoute>
            }
          />
          <Route
          ...
          <Route
            ...
            element={
              <PrivateRoute allowedRoles={['Spectator', 'Referee']}>
                <SpectatorTournamentsPage />
              </PrivateRoute>
            }
          />
          <Route
            path="/spectator/tournaments/:tournamentId"
            element={
              <PrivateRoute allowedRoles={['Spectator', 'Referee']}>
                <SpectatorTournamentDetailPage />
              </PrivateRoute>
            }
          />
          <Route
            path="/spectator/races/:raceId"
            element={
              <PrivateRoute allowedRoles={['Spectator', 'Referee']}>
                <SpectatorRaceDetailPage />
              </PrivateRoute>
            }
          />
          <Route
          ...
          <Route
            path="/vet/dashboard"
            element={
              <PrivateRoute allowedRoles={['Veterinarian', 'Vet']}>
                <VetDashboardPage />
              </PrivateRoute>
            }
          />
          <Route
            path="/vet/medical-check"
            element={
              <PrivateRoute allowedRoles={['Veterinarian', 'Vet']}>
                <MedicalCheckPage />
              </PrivateRoute>
