...
import {
  ...
  CheckCircle2, ShieldAlert, Building2, User, DollarSign,
} from 'lucide-react';
              ...
              <div>
                ...
                <div className="relative" ref={bankRef}>
                  <button
                    ...
                    className="w-full flex items-center justify-between bg-white/[0.04] border border-glass-border rounded-xl px-4 py-3 text-sm text-white hover:border-yellow-400/30 transition-colors"
                  >
                  ...
                  <input
                    ...
                    className={`w-full bg-white/[0.04] border rounded-xl pl-9 pr-4 py-3 text-sm text-white placeholder:text-muted/40 outline-none transition-colors ${
                      accError
                        ...
                        : 'border-glass-border focus:border-yellow-400/40'
                    }`}
                  />
                  {accountNo && (
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-white/[0.04] border border-glass-border rounded-xl pl-9 pr-4 py-3 text-sm text-white placeholder:text-muted/40 outline-none focus:border-yellow-400/40 transition-colors tracking-wide font-mono"
                  />
                </div>
                {holderName && (
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-[11px] font-bold text-yellow-400 hover:text-white transition-colors px-2 py-1 rounded-lg hover:bg-white/[0.06] border border-yellow-500/30"
                  >
                    All
                  </button>
                </div>
              ...
              <AnimatePresence>
                {amtNum > 0 && (
                  <motion.div
                    ...
                    className="p-4 rounded-xl bg-yellow-500/[0.06] border border-yellow-500/20 space-y-2.5"
                  >
              ...
              <button
                ...
                className={`w-full py-4 rounded-xl text-sm font-extrabold tracking-wide transition-all flex items-center justify-center gap-2 ${
                  btnDisabled
                    ...
                    : 'bg-gradient-to-r from-yellow-600 to-amber-500 hover:from-yellow-500 hover:to-amber-400 text-black shadow-lg shadow-amber-500/20 hover:shadow-amber-500/30'
                }`}
              >
                {loading
