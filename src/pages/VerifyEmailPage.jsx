  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-0 w-full px-12 py-8 z-20 bg-transparent">
        <div className="tracking-widest font-semibold cursor-pointer" style={{ fontFamily: '"Playfair Display", serif', color: '#d4af37', fontSize: '26px' }} onClick={() => navigate('/')}>
          EQUESTRIA
        </div>
      </div>
            ...
            >
              ...
              {status === 'error' && (
                <motion.div variants={fadeUp} className="text-center py-6 relative z-10 flex flex-col items-center">
                  ...
                  <button className="w-full font-bold text-sm tracking-wider uppercase py-3.5 rounded-md flex items-center justify-center gap-2 transition-all duration-300 hover:shadow-[0_0_20px_rgba(212,175,55,0.4)]" style={{ background: 'linear-gradient(135deg,#e9c46a 0%,#d4af37 50%,#aa8c2c 100%)', color: '#0b101e' }} type="button" onClick={() => navigate('/register')}>
                    Back to Register
                  </button>
                </motion.div>
              )}
