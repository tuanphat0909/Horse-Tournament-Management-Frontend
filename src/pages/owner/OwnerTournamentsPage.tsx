              ...
              {filtered.map((t, i) => {
                ...
                return (
                  <div key={t.tournamentId ?? i} className="glass-panel rounded-xl p-5 relative overflow-hidden group hover:border-gold/30 hover:bg-gold/[0.03] border border-glass-border transition-all cursor-pointer">
                    ...
                    <div className="absolute -top-8 -right-8 w-28 h-28 rounded-full bg-gradient-to-br from-gold/10 to-transparent blur-[30px] pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity" />
