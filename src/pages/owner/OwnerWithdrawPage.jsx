            ...
            <div className="space-y-5 relative z-10">
              ...
              <div>
                ...
                <div className="relative" ref={bankRef}>
                  <button onClick={() => setBankOpen((p) => !p)} className="w-full flex items-center justify-between bg-white/[0.04] border border-glass-border rounded-xl px-4 py-3 text-sm text-white hover:border-blue-400/30 transition-colors">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-lg flex items-center justify-center text-[10px] font-extrabold shrink-0" style={{ backgroundColor: bank.color + '33', border: `1px solid ${bank.color}55` }}>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <button onClick={() => setAmount(String(Math.floor(Math.min(availableUsd, dailyRemaining) / BUOC_TIEN) * BUOC_TIEN))} className="absolute right-3 top-1/2 -translate-y-1/2 text-[11px] font-bold text-blue-400 hover:text-white transition-colors px-2 py-1 rounded-lg hover:bg-white/[0.06] border border-blue-500/30">
                    All
                  </button>
                </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="p-3.5 bg-white/[0.025] rounded-xl border border-glass-border">
                  ...
                  <div className="mt-1.5 h-1 bg-white/10 rounded-full overflow-hidden">
                    <div className="h-full bg-blue-400/60 rounded-full transition-all" style={{ width: `${Math.min((dailyUsed / DAILY_LIMIT) * 100, 100)}%` }} />
                  </div>
                </div>
              </div>
              ...
              <AnimatePresence>
                {amtNum > 0 && (
                  <motion.div initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, scale: 0.98 }} className="p-4 rounded-xl bg-blue-500/[0.06] border border-blue-500/20 space-y-2.5">
