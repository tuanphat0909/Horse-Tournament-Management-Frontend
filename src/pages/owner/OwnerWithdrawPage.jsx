            ...
            <div className="space-y-5 relative z-10">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <button onClick={() => setAmount(Math.min(availableUsd, dailyRemaining).toFixed(2))} className="absolute right-3 top-1/2 -translate-y-1/2 text-[11px] font-bold text-blue-400 hover:text-white transition-colors px-2 py-1 rounded-lg hover:bg-white/[0.06] border border-blue-500/30">
                    All
                  </button>
                </div>
