      ...
      <main className="flex-grow flex items-center justify-center relative z-10 px-6 py-12 lg:px-16 w-full max-w-[1600px] mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-center w-full">
          ...
          <motion.section className="hidden lg:flex flex-col items-center justify-center text-center px-8" initial={{ opacity: 0, x: -40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7 }}>
            <div className="mb-10">
              <h1 className="italic font-medium mb-6 leading-tight" style={{ fontFamily: '"Playfair Display", serif', color: '#e9c46a', fontSize: '56px', lineHeight: '1.15' }}>
                "Join the Legacy."
              </h1>
              ...
              >
                ...
                {!isRegistered ? (
                    ...
                    <div className="space-y-4 relative z-10">
                      ...
                      <motion.div variants={fadeUp}>
                        ...
                        <div className="relative">
                          ...
                          <button className="absolute inset-y-0 right-0 flex items-center pr-3" style={{ color: '#94a3b8' }} type="button" onClick={() => setShowConfirm(!showConfirm)}>
                  ...
                  <motion.div variants={fadeUp} className="text-center py-6 relative z-10 flex flex-col items-center">
                    ...
                    <button className="w-full font-bold text-sm tracking-wider uppercase py-3.5 rounded-md flex items-center justify-center gap-2 transition-all duration-300 hover:shadow-[0_0_20px_rgba(212,175,55,0.4)]" style={{ background: 'linear-gradient(135deg,#e9c46a 0%,#d4af37 50%,#aa8c2c 100%)', color: '#0b101e' }} type="button" onClick={() => navigate('/login')}>
                      Go to Sign In
                    </button>
                  </motion.div>
                )}
