...
export function PageHero({ title, subtitle, imageUrl, imagePosition = 'right center', badge, actions }) {
  return (
    ...
    >
      <motion.div initial={{ opacity: 0, y: -12 }} animate={{ opacity: 1, y: 0 }} className="rounded-2xl overflow-hidden relative" style={{ minHeight: '215px', borderRadius: '15px', backgroundColor: '#0b1224' }}>
