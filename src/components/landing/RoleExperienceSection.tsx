  ...
  return (
    <div className="p-4 flex-1 flex flex-col gap-2.5 overflow-hidden">
      <div className="rounded-lg bg-gradient-to-r from-gold/10 to-transparent border border-gold/15 p-2.5">
        ...
        <div className="text-slate-900 font-serif text-sm">{t('Welcome,')} <span className="italic text-[#8A6D25]">Andy Nguyen</span></div>
      </div>

      {/* Ba ô khớp đúng card trên Owner Dashboard thật, đơn vị tiền là coins (¢) */}
      <div className="grid grid-cols-3 gap-1.5">
        {[
          { value: '12', label: t('My Horses'), color: 'text-[#B58A30]' },
      ...
      <div className="flex-1 space-y-1.5 overflow-hidden">
        <div className="text-[9px] text-slate-400 uppercase tracking-widest">{t('My Horses')}</div>
        {[
      ...
      <div className="h-7 rounded-lg bg-[#B58A30]/10 border border-[#B58A30]/30 flex items-center justify-center">
        <span className="text-[10px] text-[#B58A30] font-bold">+ {t('Add Horse')}</span>
      </div>
    </div>
  );
};
  ...
  return (
    <div className="p-4 flex-1 flex flex-col gap-2.5 overflow-hidden">
      <div className="rounded-lg bg-gradient-to-r from-blue-500/10 to-transparent border border-blue-500/15 p-2.5">
        ...
        <div className="text-slate-900 font-serif text-sm">{t('Welcome,')} <span className="italic text-[#8A6D25]">David Tran</span></div>
      </div>

      <div className="grid grid-cols-3 gap-1.5">
        {[
          { value: '45', label: t('Total Wins'), color: 'text-[#B58A30]' },
      ...
      <div className="flex-1 space-y-1.5 overflow-hidden">
        <div className="text-[9px] text-slate-400 uppercase tracking-widest">{t('Race Invitations')}</div>
        {[
          ...
          <div key={i} className="p-2 rounded-lg bg-slate-50 border border-slate-200">
            <div className="flex items-start justify-between gap-2">
              <div className="min-w-0">
                ...
                <div className="text-[9px] text-slate-400">{t('Owner')}: {inv.owner}</div>
              </div>
  ...
  return (
    <div className="p-4 flex-1 flex flex-col gap-2.5 overflow-hidden">
      <div className="rounded-lg bg-gradient-to-r from-emerald-500/10 to-transparent border border-emerald-500/15 p-2.5">
        ...
        <div className="text-slate-900 font-serif text-sm">{t('Welcome,')} <span className="italic text-[#8A6D25]">William Nguyen</span></div>
      </div>
      ...
      <div className="flex-1">
        <div className="text-[9px] text-slate-400 uppercase tracking-widest mb-1.5">{t('Pending Violations')}</div>
        <div className="p-2.5 rounded-lg bg-red-500/5 border border-red-500/20">
          ...
          <div className="flex gap-1.5">
            ...
            <div className="flex-1 h-5 rounded bg-slate-100 border border-slate-200 flex items-center justify-center">
              <span className="text-[9px] text-slate-500 font-bold">{t('Dismiss')}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="p-2 rounded-lg bg-slate-50 border border-slate-200">
        <div className="flex justify-between items-center mb-1">
          <span className="text-[9px] text-slate-500">{t('Horse Inspection')}</span>
  ...
  return (
    <div className="p-4 flex-1 flex flex-col gap-2.5 overflow-hidden">
      <div className="rounded-lg bg-gradient-to-r from-red-500/10 to-transparent border border-red-500/15 p-2.5">
        ...
        <div className="text-slate-900 font-serif text-sm">{t('Welcome,')} <span className="italic text-[#8A6D25]">Alex Howard</span></div>
      </div>
        ...
        {[
          ...
          <div key={i} className="flex items-center gap-1.5 mb-1">
            ...
            <div className="flex-1 h-1.5 rounded-full bg-slate-200">
              <div
                className={`h-full rounded-full ${i === 0 ? 'bg-gradient-to-r from-[#B58A30] to-yellow-600' : 'bg-white/25'}`}
                style={{ width: h.bar }}
              />
            </div>
      ...
      <div className="flex-1 overflow-hidden">
        ...
        <div className="text-[9px] text-slate-400 uppercase tracking-widest mb-1.5">{t('My Bets')}</div>
        {[
          ...
          <div key={i} className="flex items-center gap-2 py-1 px-1.5 rounded-lg hover:bg-slate-50 mb-0.5">
            <span className={`text-[10px] w-3 ${p.correct === true ? 'text-emerald-400' : 'text-slate-400'}`}>
              {p.correct === true ? '✓' : '⏳'}
            </span>
      ...
      <div className="flex gap-2">
        <div className="flex-1 h-7 rounded-lg bg-[#B58A30]/10 border border-[#B58A30]/30 flex items-center justify-center">
          <span className="text-[10px] text-[#B58A30] font-bold">{t('Watch Live')}</span>
        </div>
        ...
        >
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="relative z-10 w-full h-full border border-slate-200 rounded-xl bg-white shadow-2xl flex flex-col overflow-hidden"
            >
              {/* Mock Browser Bar */}
