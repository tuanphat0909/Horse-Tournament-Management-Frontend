...
function getSections() {
  return Array.from(document.querySelectorAll('.landing-section'));
}
...
export function SectionScroller() {
  ...
  const btnCls = 'w-9 h-9 rounded-full glass-panel border border-gold/25 flex items-center justify-center ' + 'text-gold hover:text-champagne hover:border-gold/50 hover:shadow-[0_0_14px_rgba(201,168,76,0.35)] ' + 'transition-all duration-200 backdrop-blur-md';
