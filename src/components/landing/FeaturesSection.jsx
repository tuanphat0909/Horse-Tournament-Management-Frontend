      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <motion.div className="text-center mb-24" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
          <h2 className="text-4xl md:text-5xl font-serif text-white mb-6">
            {'Engineered for'} <span className="text-gradient-gold italic">{'Excellence'}</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-50px' }} transition={{ delay: 0.1, duration: 0.6 }} onClick={() => navigate('/login')} className="feature-card p-0 rounded-2xl group cursor-pointer overflow-hidden relative md:col-span-2 flex flex-col md:flex-row">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-50px' }} transition={{ delay: 0.2, duration: 0.6 }} onClick={() => navigate('/login')} className="feature-card p-0 rounded-2xl group cursor-pointer overflow-hidden relative flex flex-col">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-50px' }} transition={{ delay: 0.3, duration: 0.6 }} onClick={() => navigate('/login')} className="feature-card p-0 rounded-2xl group cursor-pointer overflow-hidden relative flex flex-col">
            <div className="p-8 pb-4 z-10 relative">
              <div className="w-12 h-12 rounded-xl bg-navy/80 border border-glass-border flex items-center justify-center mb-6 shadow-[0_0_15px_rgba(201,168,76,0.2)]">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-50px' }} transition={{ delay: 0.4, duration: 0.6 }} onClick={() => navigate('/login')} className="feature-card p-0 rounded-2xl group cursor-pointer overflow-hidden relative md:col-span-2 flex flex-col md:flex-row-reverse">
            <div className="p-10 flex-1 z-10 flex flex-col justify-center">
              <div className="w-12 h-12 rounded-xl bg-navy/80 border border-glass-border flex items-center justify-center mb-6 shadow-[0_0_15px_rgba(201,168,76,0.2)]">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-50px' }} transition={{ delay: 0.5, duration: 0.6 }} onClick={() => navigate('/login')} className="feature-card p-10 rounded-2xl group cursor-pointer overflow-hidden relative flex flex-col justify-center md:col-span-3 items-center text-center">
