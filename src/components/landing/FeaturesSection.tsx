        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <div className="relative w-full md:w-[55%] h-64 md:h-auto overflow-hidden">
               <div className="absolute inset-0 bg-linear-to-r from-[rgba(32,54,90,0.95)] via-transparent to-transparent z-10 hidden md:block" />
               <div className="absolute inset-0 bg-linear-to-t from-[rgba(32,54,90,0.95)] via-transparent to-transparent z-10 md:hidden" />
          ...
          >
            ...
            <div className="flex-1 relative w-full mt-4">
              <div className="absolute inset-0 bg-linear-to-t from-navy/50 to-transparent z-10 pointer-events-none" />
          ...
          >
            ...
            <div className="relative w-full md:w-[55%] h-64 md:h-auto overflow-hidden bg-navy/30">
               <div className="absolute inset-0 bg-linear-to-l from-[rgba(32,54,90,0.95)] via-transparent to-transparent z-10 hidden md:block" />
               <div className="absolute inset-0 bg-linear-to-t from-[rgba(32,54,90,0.95)] via-transparent to-transparent z-10 md:hidden" />
          ...
          >
            <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,var(--tw-gradient-stops))] from-gold/5 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none" />
            <div className="relative z-10 w-full max-w-3xl mx-auto flex flex-col items-center">
                <div className="w-16 h-16 rounded-2xl bg-linear-to-br from-green-500/20 to-emerald-900/40 border border-green-500/30 flex items-center justify-center mb-6 shadow-[0_0_30px_rgba(34,197,94,0.15)] group-hover:shadow-[0_0_50px_rgba(34,197,94,0.3)] group-hover:scale-110 transition-all duration-500">
